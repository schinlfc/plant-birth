...
Field journals for this project (coal decommissioning → air pollution → infant health). Same disposition taxonomy (STRUCTURAL / CREDIBILITY / MEASUREMENT / POLICY / THEORY / SKEPTIC). For all of these, the likely `paper_type` is **reduced-form** (staggered DiD / event study); the methods-referee should apply the staggered-adoption sanity check.

### Journal of Health Economics (JHE)

**Short name:** `JHE`

**Focus.** Leading field journal in health economics. Credible causal estimates of health-relevant exposures/policies on health and behavior. Reduced-form welcome; mechanism and policy interpretation expected.

**Bar.** Clean identification + a health outcome that matters + honest discussion of mechanisms and external validity. Not a general-interest novelty bar, but the design must be defensible to a skeptical applied micro audience.

**Domain-referee adjustments.**
- Contribution 30 → 30 (unchanged); External validity 15 → 20 (generalizability of the exposure–health link matters).

**Methods-referee adjustments.**
- Identification 35 → 40 (credibility is load-bearing); Inference 20 → 20 (clustering + MHT across outcomes scrutinized).

**Typical concerns.**
- "Is the exposure measure (pollution) credibly attributed to the treatment (decommissioning)?"
- "Are health outcomes measured well, and is the sample/selection (who is born near plants) handled?"
- "Under staggered timing, is the estimator robust to heterogeneous effects?"
- "Are standard errors clustered at the right level, and is multiple testing across outcomes addressed?"
...
**Table format override.** None specific; report N, clustering, and outcome-family MHT adjustment.

### American Journal of Health Economics (AJHE)

**Short name:** `AJHE`

**Focus.** Broad health economics (ASHEcon's journal). Receptive to environmental-health, infant-health, and policy-evaluation work. Values clear policy relevance alongside credible design.

**Bar.** Similar credibility bar to JHE with a slightly stronger appetite for policy framing and U.S. institutional detail.

**Domain-referee adjustments.**
- Contribution 30 → 32; Policy relevance weighted up (POLICY pool weight high).

**Methods-referee adjustments.**
- Identification 35 → 40; Robustness 15 → 15.

**Typical concerns.**
- "What is the policy takeaway — does this inform decommissioning / air-quality regulation?"
- "Is the design credible and the exposure–outcome chain complete?"
- "Are the magnitudes economically meaningful and comparable to the pollution-health literature?"
...
**Focus.** Flagship environmental + resource economics. Strong on pollution-exposure identification, measurement of environmental quality, and the economics of the pollution-health relationship.

**Bar.** The environmental-exposure link must be measured and identified carefully (monitor data, attribution, spatial structure). Reduced-form health effects welcome if the pollution channel is rigorous.

**Domain-referee adjustments.**
- Substance 20 → 25 (the environmental measurement is part of the contribution); External validity 15 → 20.

**Methods-referee adjustments.**
- Identification 35 → 40; Estimation 25 → 25; emphasize exposure measurement / spatial inference.

**Typical concerns.**
- "Is ambient pollution measured and attributed to the plant credibly (distance, capacity, drift, other sources)?"
- "Is spatial dependence handled (clustering, SUTVA/spillovers across tracts)?"
- "Does the first link (capacity → ambient concentration) hold before the health link is estimated?"
- "Are the dose-response (distance × capacity) results consistent with the binary treatment results?"
...
**Table format override.** None specific; report spatial-clustering choices explicitly.

### AEJ: Applied Economics (AEJ-Applied)

**Short name:** `AEJ-Applied`

**Focus.** Top applied-micro field journal. Clever, credible empirical designs with clean identification and careful execution. Infant-health / pollution natural experiments are squarely in scope.

**Bar.** Near-QJE identification taste at the field level. The design should be teachable; robustness targeted not theatrical.

**Domain-referee adjustments.**
- Contribution 30 → 32; Substance 20 → 25 (design cleverness rewarded).

**Methods-referee adjustments.**
- Identification 35 → 45 (house style); Robustness 15 → 10 (targeted, not coverage); Replication 5 → 10 (AEA Data Editor).

**Typical concerns.**
- "Is the natural experiment genuinely clean, or is this a generic TWFE DiD with staggered-timing problems?"
- "Do pre-trends and the heterogeneity-robust estimator hold up?"
- "Is selection (migration/fertility composition near plants) ruled out?"
- "Is the replication package AEA-compliant?"
...
**Table format override.** No significance stars (AEA policy since 2023); SE in parentheses, p-values in notes if needed.

### AEJ: Economic Policy (AEJ-Policy)

**Short name:** `AEJ-Policy`

**Focus.** Top applied field journal with a policy lens. Credible designs whose results speak directly to policy (here: the health co-benefits of coal retirement / air-quality regulation).

**Bar.** Same credibility bar as AEJ-Applied, with explicit policy relevance and welfare/benefit framing expected.

**Domain-referee adjustments.**
- Contribution 30 → 32; External validity 15 → 20; POLICY weighted up.

**Methods-referee adjustments.**
- Identification 35 → 42; Replication 5 → 10.

**Typical concerns.**
- "What does this say to a regulator weighing coal-plant retirement against costs?"
- "Are the health benefits quantified in a policy-usable way (and not over-claimed)?"
- "Is the design credible and robust to staggered-timing critiques?"
...
**Table format override.** No significance stars (AEA policy).

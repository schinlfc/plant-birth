...
- **Staggered-adoption check.** If treatment timing varies across units, is a heterogeneity-robust estimator used (Callaway–Sant'Anna, Sun–Abraham, de Chaisemartin–D'Haultfœuille, Borusyak et al.)? A plain TWFE event study under staggered timing is a MAJOR concern (negative weights / forbidden comparisons; Goodman-Bacon 2021).

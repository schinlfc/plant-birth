...
## COMPLETE multi-pollutant result (2026-06-03)

[LEARN:result] **Link-2 (coal emissions → local ambient pollution) fails across PM2.5, SO2, AND lead** (`scripts/stata/07/08/09`). First-stage coal→ambient (tract+year FE): PM2.5 F=0.25; SO2 p=0.97; lead p=0.061 (only hint, 10 clusters, F~4.6 weak). Treatment→plant-emissions strong (CEMS) but treatment→population-ambient-exposure ~zero → no identifiable infant-health co-benefit via ambient exposure. General PM2.5 shows borderline tail/mortality (LBW p=.065, fetal p=.10) but NOT coal-attributable. Mechanism: coal SO2/NOx→regional secondary PM not local; ambient SO2/lead very low; coal small marginal contributor to local ambient in 2005-2010 TX. **This is a robust, well-identified NULL.** Decision: frame as precise-null co-benefit paper / reframe to general PM2.5 / return to lead-proximity-IQ / reconsider viability. Uncommitted: scripts 08,09 + README UPDATE 7.
